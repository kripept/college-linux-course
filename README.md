...
2. [VirtualBox 7.2](https://www.virtualbox.org/wiki/Download_Old_Builds_7_2) / [VirtualBox 6.0 (для старых пк(слабое железо или старая ОС), но чтобы не отставать сильно в версии)](https://www.virtualbox.org/wiki/Download_Old_Builds_6_0) (Выбирать установщик по вашей ОС) 
